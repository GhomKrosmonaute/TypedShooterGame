...
export default class Cursor extends Dirigible {
  ...
  constructor(public app: App) {
    super(app.p, app.mouseFromCenter.x, app.mouseFromCenter.y, 5)
  }

  private get auraDiameter(): number {
    return 15 + Math.min(30, this.rawDist(this.app.mouseFromCenter) * 0.5)
  }

  public step(): void {
    this.target(this.app.mouseFromCenter, 0.5)
  }
